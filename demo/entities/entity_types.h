...
#define ENTITY_TYPE_DEMO_DIALOG 16
#define ENTITY_TYPE_INFO_DIALOG 17
#define ENTITY_TYPE_JIMBO_DIALOG 18
#define ENTITY_TYPE_SIGN_DIALOG 19

// This is the total number of entity types.
#define ENTITY_TYPE_MAX 20
