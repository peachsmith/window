/**
 * Deprecated
 * This file is in the process of being replaced by the pause menu entity.
 * 
 */
...
//     // Render function.
//     pause_menu.render = NULL; // render_pause_menu;
...
//     // TODO: tell the application that the pause menu is now the active menu.
// }
